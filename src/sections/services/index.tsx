  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col justify-start max-w-[50rem] min-h-[32rem] text-sm md:text-base">
          {selected && (
            <motion.div
              key={selected}
              initial="hidden"

...
const Card = ({
  ...
  return (
    ...
    >
      <img
        src={imgSrc}
        className="absolute inset-0 blur-sm scale-[1.05] saturate-50 md:saturate-0 md:group-hover:saturate-100 group-hover:scale-[1.15] group-hover:blur-none transition-all duration-500 object-cover object-center"
        loading="eager"
